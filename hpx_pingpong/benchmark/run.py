...
configs = [
    ...
    {**baseline, "name": "lci-intensity", "intensity": [1, 30, 350, 3370, 40000], "enable_comp_timer": 1, "ndevices": [1, 2, 4, 8, 10, 20]},
    ...
    {**baseline, "name": "lcw-intensity", "intensity": [1, 30, 350, 3370, 40000], "enable_comp_timer": 1, "parcelport": "lcw", "ndevices": [1, 2, 4, 8, 10, 20]},
]
