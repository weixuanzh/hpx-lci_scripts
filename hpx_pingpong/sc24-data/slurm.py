...
pshell.run("export UCX_RNDV_THRESH=65536")
pshell.run("export UCX_MAX_RNDV_RAILS=1")
pshell.run("export UCX_BCOPY_THRESH=32")
pshell.run("export LCI_UCX_USE_TRY_LOCK=0")
pshell.run("export UCX_NET_DEVICES=mlx5_0:1")
pshell.run("export TCMALLOC_MAX_TOTAL_THREAD_CACHE_BYTES=1677721600")
pshell.run("export LCI_LOG_LEVEL=error")
pshell.run("export UCX_LOG_LEVEL=trace")
pshell.run("export LCT_LOG_LEVEL=error")
