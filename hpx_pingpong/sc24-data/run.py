...
hpx_configs1 = [
    {"name": "lci-ucx", "parcelport": "lci", "spack_env": "hpx"}, 
    {"name": "lci-ibv", "parcelport": "lci", "spack_env": "hpx_lci_ibv"},
    {"name": "mpi", "parcelport": "mpi", "spack_env": "hpx"},
    {"name": "mpi_a", "parcelport": "mpi", "sendimm": "0"},
]

hpx_configs_test = [
    {"name": "hpx_ucx_debug", "parcelport": "lci", "spack_env": "hpx_ucx_debug", "zc_threshold" : "65536"}, 
]
...
pingpong_configs1 = [
    ...
    {"pingpong_config_name": "nchains", "nbytes": [16384], "nchains": [1, 4, 16, 64, 256, 1024, 4096], "nsteps": [100]},
...
pingpong_configs2 = [
    {"pingpong_config_name": "flood", "nchains": [50000], "nsteps": [1], "is_single_source": 1, "nbytes": [8, 16384], "batch_size": 100, "nthreads": nthreads},
    # {"pingpong_config_name": "flood", "nchains": [flood_16k_nchains], "nsteps": [1], "is_single_source": 1, "nbytes": [16384], "batch_size": 10, "nthreads": nthreads},
    {"pingpong_config_name": "nchains", "nbytes": [8, 16384], "nchains": [1024], "nthreads": nthreads},
]

pingpong_configs_test = [
    {"pingpong_config_name": "test", "nbytes": [16384], "nchains": [1], "nthreads": [2], "nsteps": [1]},
]

update_outside = None
update_inside = None
configs = dict_product(baseline, hpx_configs_test, pingpong_configs_test)
# configs = [baseline]
# update_outside = hpx_configs1
# update_inside = pingpong_configs1
